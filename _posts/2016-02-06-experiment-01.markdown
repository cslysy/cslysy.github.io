...
New dependencies can be added in a two ways, manually or using a command. In order to add bootstrap just add it within *dependencies* just like that:
{% highlight json %}
{
  "dependencies": {
    "jquery": "^2.2.0",
